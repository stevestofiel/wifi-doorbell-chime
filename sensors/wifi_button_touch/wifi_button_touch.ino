...
const int TOUCH_ACTIVE_LEVEL = LOW;
const bool TOUCH_EMIT_ON_STABLE_CHANGE = true;
...
void setup() {
  ...
  Serial.printf("Touch emits on stable change: %s\n", TOUCH_EMIT_ON_STABLE_CHANGE ? "yes" : "no");
